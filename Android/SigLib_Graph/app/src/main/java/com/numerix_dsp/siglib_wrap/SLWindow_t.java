...
public final class SLWindow_t {
  ...
  public final static SLWindow_t SIGLIB_BMAN_HARRIS = new SLWindow_t("SIGLIB_BMAN_HARRIS");
  ...
  private static SLWindow_t[] swigValues = { SIGLIB_HANNING, SIGLIB_HAMMING, SIGLIB_BLACKMAN, SIGLIB_BARTLETT_TRIANGLE_ZERO_END_POINTS, SIGLIB_BARTLETT_TRIANGLE_NON_ZERO_END_POINTS, SIGLIB_KAISER, SIGLIB_BMAN_HARRIS, SIGLIB_RECTANGLE, SIGLIB_FLAT_TOP };
