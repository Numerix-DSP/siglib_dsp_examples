...
static SLArrayIndex_t   FFTSize, Log2FFTSize;
...
static SLData_t     InverseFFTSize, InverseArbFFTSize;
...
void main(void)
{
    ...
    SIF_ArbAutoCrossPowerSpectrum (AWNrPtr,                     // Pointer to AWNr coefficients
                                   ...
                                   &InverseFFTSize,             // Pointer to inverse FFT length
                                   &InverseArbFFTSize,          // Pointer to inverse dataset length
    ...
    SDA_ArbAutoPowerSpectrum (pRealData1,                   // Pointer to real source array
                              ...
                              InverseFFTSize,               // Inverse FFT length
                              InverseArbFFTSize,            // Inverse arbitrary FFT length
