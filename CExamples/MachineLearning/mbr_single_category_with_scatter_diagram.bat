...
REM Build and run single category training and validation + plot the scatter diagram
...
network_validate_single_category -0 Machine1 -1 Machine2 -e 6 -s
echo.
...
network_validate_single_category -0 Machine1 -1 Machine3 -e 6 -s
echo.
...
network_validate_single_category -0 Machine1 -1 Machine4 -e 6 -s
echo.
...
network_validate_single_category -0 Machine2  -1 Machine3 -e 6 -s
echo.
...
network_validate_single_category -0 Machine2  -1 Machine4 -e 6 -s
echo.
...
network_validate_single_category -0 Machine3  -1 Machine4 -e 6 -s
echo.
