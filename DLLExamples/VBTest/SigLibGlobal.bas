...
Global Const SIGLIB_BLACKMAN As Long = 2
Global Const SIGLIB_BARTLETT_TRIANGLE_ZERO_END_POINTS As Long = 3
Global Const SIGLIB_BARTLETT_TRIANGLE_NON_ZERO_END_POINTS  As Long = 4
Global Const SIGLIB_KAISER As Long = 5
Global Const SIGLIB_BMAN_HARRIS As Long = 6
Global Const SIGLIB_RECTANGLE As Long = 7
Global Const SIGLIB_FLAT_TOP As Long = 8



' Signal generation     types
Global Const SIGLIB_SINE_WAVE As Long = 0
Global Const SIGLIB_COS_WAVE As Long = 1
