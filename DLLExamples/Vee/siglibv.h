...
void _stdcall SDA_Rfft (double * SIGLIB_INOUT_PTR_DECL,   // Pointer to real source array
...
void _stdcall SDA_Cfft (double * SIGLIB_INOUT_PTR_DECL,   // Pointer to real source array
    double * SIGLIB_INOUT_PTR_DECL,               // Pointer to imaginary array
     double * SIGLIB_INPUT_PTR_DECL,         // Pointer to FFT coefficients
     long * SIGLIB_INPUT_PTR_DECL,   // Pointer to bit reverse address table
     long,                           // FFT size
...
void _stdcall SDA_Cifft (double * SIGLIB_INOUT_PTR_DECL,  // Pointer to real source array
    double * SIGLIB_INOUT_PTR_DECL,               // Pointer to imaginary array
     double * SIGLIB_INPUT_PTR_DECL,         // Pointer to FFT coefficients
     long * SIGLIB_INPUT_PTR_DECL,   // Pointer to bit reverse address table
     long,                           // FFT size
...
void _stdcall SIF_FastBitReverseReorder (long * SIGLIB_OUTPUT_PTR_DECL,   // Pointer to bit reverse address table
     long);                          // Vector length
...
void _stdcall SIF_FftArb (double * SIGLIB_OUTPUT_PTR_DECL,    // Pointer to AWNr coefficients
    ...
    long *,                               // Pointer to FFT size
    long *,                               // Pointer to Log 2 FFT size
    double *,                                     // Pointer to the inverse FFT size
    double *,                                     // Pointer to the inverse (Sample length * FFT size)
     long);                          // Array length
...
void _stdcall SDA_RfftArb ( double * SIGLIB_INPUT_PTR_DECL,  // Pointer to real source array
    ...
    double * SIGLIB_INOUT_PTR_DECL,               // Pointer to imaginary temporary array
     ...
     long,                           // Log 2 FFT size
     double,                                 // Inverse FFT size
     double,                                 // Inverse (Sample length * FFT size)
     long);                          // Arbitrary FFT size
...
void _stdcall SIF_FastAutoCrossPowerSpectrum (double * SIGLIB_OUTPUT_PTR_DECL,    // Pointer to FFT coefficients
    long * SIGLIB_OUTPUT_PTR_DECL,        // Pointer to bit reverse address table
    double *,                                     // Pointer to inverse FFT Size
     long);                          // FFT Size
...
void _stdcall SDA_ArbAutoPowerSpectrum (double * SIGLIB_INOUT_PTR_DECL,   // Pointer to real source array
    ...
    double * SIGLIB_INOUT_PTR_DECL,               // Pointer to imaginary temporary array
     ...
     long,                           // Log 2 FFT size
     double,                                 // Inverse FFT Size
     double,                                 // Inverse arbitrary FFT size
     long);                          // Arbitrary FFT size
...
void _stdcall SDA_VariableDelay ( double * SIGLIB_INPUT_PTR_DECL,    // Pointer to the input array
    ...
    long *,                               // Pointer to the FIFO output index
     long,                           // Maximum delay length
     long);                          // Input / output sample length
...
long _stdcall SDA_MaxPos ( double * SIGLIB_INPUT_PTR_DECL, // Pointer to source array
     long);                          // Array length

long _stdcall SDA_AbsMaxPos ( double * SIGLIB_INPUT_PTR_DECL,  // Pointer to source array
     long);                          // Array length

long _stdcall SDA_MinPos ( double * SIGLIB_INPUT_PTR_DECL, // Pointer to source array
     long);                          // Array length

long _stdcall SDA_AbsMinPos ( double * SIGLIB_INPUT_PTR_DECL,  // Pointer to source array
     long);                          // Array length
...
void _stdcall SDA_Envelope ( double * SIGLIB_PTR_DECL, // Pointer to source array
    double * SIGLIB_PTR_DECL,                     // Pointer to destination array
     ...
     double,                                 // Decay coefficient
    double * SIGLIB_PTR_DECL,                     // Pointer to filter state variable
     long);                          // Input array sample length
...
void _stdcall SDA_Offset ( double * SIGLIB_INPUT_PTR_DECL,   // Pointer to source array
     double,                                 // Offset
    double * SIGLIB_OUTPUT_PTR_DECL,              // Pointer to destination array
     long);                          // Array length
